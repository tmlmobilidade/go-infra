...
# # #
# COMPUTE
# Single Valhalla VM with attached block volume for tiles/PBF.

resource "oci_core_instance" "valhalla" {
...
resource "oci_core_volume_attachment" "valhalla_data" {

	instance_id = oci_core_instance.valhalla.id
