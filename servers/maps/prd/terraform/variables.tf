...
variable "base_image_ocid" {
	type = string
	description = "OCID of the Packer-built Maps image. Set after packer build."
	default = "ocid1.image.oc1.eu-frankfurt-1.aaaaaaaasx2ljkpx7waqigssj5itpgbqpntopvdhvnn575k7m6t27qwowpiq"
}
...
variable "block_volume_ocid" {
	type = string
	description = <<-EOT
	OCID of an existing block volume for Maps data.
	EOT
	default = "ocid1.volume.oc1.eu-frankfurt-1.abtheljtluhpphrirzmj37pxswwooip7omtaii6ekm5hhordmsahssb4o6qa"
}
