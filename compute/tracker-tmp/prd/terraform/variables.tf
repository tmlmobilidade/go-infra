...
variable "display_name" {
	...
	default = "iso-go-prd-tracker-tmp"
}
...
variable "base_image_ocid" {
	...
	EOT
	default = "ocid1.image.oc1.eu-frankfurt-1.aaaaaaaa7aahqn7wdjgndiasif5jw4miruktqbccrbkamzxs4pmtmr5ykbvq"
}
