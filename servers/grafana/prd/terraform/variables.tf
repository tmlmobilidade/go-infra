...
variable "base_image_ocid" {
	type = string
	description = "OCID of the Packer-built Grafana image. Set after packer build."
	default = "ocid1.image.oc1.eu-frankfurt-1.aaaaaaaar2arwfw3wg5spfznea6gefmtdogyeuiaarmdlbtjaswnue4zh27a"
}
...
variable "block_volume_ocid" {
	type = string
	description = <<-EOT
	OCID of an existing block volume for Grafana data.
	EOT
	default = "ocid1.volume.oc1.eu-frankfurt-1.abtheljt4vdrro22cflw6dojbqp5k4qqwollrqv22llrsvqddy6l73zfqvqq"
}
