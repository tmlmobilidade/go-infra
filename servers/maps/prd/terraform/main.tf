...
resource "oci_core_instance" "maps" {
	...
	metadata = {
		...
		# cloud-init runs on first boot and configures Maps.
...
resource "oci_core_volume_attachment" "maps_data" {

	instance_id = oci_core_instance.maps.id
