...
docker compose exec -T mongodb mongosh \
  ...
  --authenticationDatabase admin <<EOF
	...
	rs.initiate({
		_id: "rs0",
		members: [
			{ _id: 0, host: "go-prd-godb-1.tmlmobilidade.pt:27017", priority: 1 },
			{ _id: 1, host: "go-prd-godb-2.tmlmobilidade.pt:27017", priority: 0.5 },
			{ _id: 2, host: "go-prd-godb-3.tmlmobilidade.pt:27017", priority: 0.5 }
		]
	})
