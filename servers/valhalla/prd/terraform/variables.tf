...
variable "base_image_ocid" {
	...
	default = "ocid1.image.oc1.eu-frankfurt-1.aaaaaaaa2a5dqzczf3rain6vtbas2s6rvl2dmodh7oco6vqymbg7dijhzi2q"
}
...
variable "block_volume_ocid" {
	...
	EOT
	default = "ocid1.volume.oc1.eu-frankfurt-1.abtheljtrkksfzp2o5nonug7c36sk3z7yatdrfb6y4bs7vlncpooyq4f4o7q"
}
