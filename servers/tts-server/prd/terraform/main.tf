...
# # #
# COMPUTE
# Single TTS Server VM.

resource "oci_core_instance" "tts-server" {
	...
	metadata = {
		...
		# cloud-init runs on first boot and configures TTS Server.
...
# resource "oci_core_volume_attachment" "tts-server_data" {

# 	instance_id = oci_core_instance.tts-server.id
