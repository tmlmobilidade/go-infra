...
variable "base_image_ocid" {
	...
	default = " ocid1.image.oc1.eu-frankfurt-1.aaaaaaaagolmesnhkowpbtny2yfudfsd3vzvop4ldwlyzbiz7dnxwrwcyjfq"
}
...
variable "block_volume_ocids" {
	...
	EOT
	default = [
		"ocid1.volume.oc1.eu-frankfurt-1.abtheljtnblsia6vahbin33swke4lgeqv77v77cz66swkvzz4wvkdcibkbra"
	]
}
